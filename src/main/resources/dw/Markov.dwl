...
var classes = ["Artificer", "Rogue", "Ranger", "Sorcerer", "Druid", "Bard", "Mage", "Warlock", "Fighter", "Barbarian", "Monk", "Paladin"]
var races = ["Elf", "Human", "Half Elf", "Goblin", "Tiefling", "Dwarf", "Gnome", "Dragonborn", "Undead", "Half Orc"]
var alignments = ["Lawful Good", "Lawful Neutral", "Lawful Evil", "Neutral Good", "True Neutral", "Neutral Evil", "Chaotic Good", "Chaotic Neutral", "Chaotic Evil"]
...
fun generateCharacterClass() = classes[randomInt(sizeOf(classes))]
fun generateCharacterRace() = races[randomInt(sizeOf(races))]
fun generateCharacterAlignment() = alignments[randomInt(sizeOf(alignments))]
...
fun generateCharacters(count) = (1 to count) map do {
	...
	---
	{
		...
		race: generateCharacterRace(),
		alignment: generateCharacterAlignment(),
		level: level,
